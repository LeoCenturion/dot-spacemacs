...
before packages are loaded."
  ...
  (add-hook
   'obsidian-mode-hook
   (lambda ()    ;; Replace standard command with Obsidian.el's in obsidian vault:
  ...
  (global-set-key (kbd "M-m M-r") 'lsp-rename)
